...
const RESPONSIVE_MODE = true;
const MOBILE_ASPECT_RATIO_THRESHOLD = 0.75; 
const DESKTOP_ASPECT_RATIO_THRESHOLD = 1.2; 


const CAMERA_THRESHOLD_BASE = 200; 
const CAMERA_THRESHOLD_RATIO = 0.25; 


const RENDER_MARGIN_TOP = 100; 
const RENDER_MARGIN_BOTTOM = 200; 
